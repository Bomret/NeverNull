...
namespace NeverNull.Tests.Combinators {
    ...
    public class When_I_create_an_option_from_two_and_would_return_a_some_with_value_zero_if_it_would_be_a_none {
        private static IOption<int> _two;
        private static IOption<int> _result;

        private Establish context = () => _two = Option.Create(2);
